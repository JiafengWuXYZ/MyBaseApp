...
import com.wujiafeng.mybaseapp.util.Utils;
 ...
 */
public class GlideTransformationsAdapter extends RecyclerView.Adapter<GlideTransformationsAdapter.ViewHolder> {

    private Context mContext;
    private List<String> mData = new ArrayList<>();

    public GlideTransformationsAdapter(Context context) {
        mContext = context;
        for (int i = 1; i <= 21; i++) {
            mData.add(i + "");
        }
